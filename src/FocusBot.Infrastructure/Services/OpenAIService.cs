...
/// <summary>
/// Service that classifies window/task alignment using the OpenAI API.
/// </summary>
public class OpenAIService : IOpenAIService
{
    ...
    private const string SystemPrompt = """
        ...
        - 1-3: Window does not support the stated task
        - 4-5: Ambiguous or unclear relationship
